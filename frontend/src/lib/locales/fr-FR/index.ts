export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Podcast Geeker est injoignable",
    ...
    docLink: "Documentation de Podcast Geeker",
  ...
  podcasts: {
    ...
    generationModeMultiAgentHint: "Le mode Multi-Agent est en aperçu — il exécute actuellement le pipeline legacy.",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Podcast Geeker à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Podcast Geeker est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Podcast Geeker",
    missingRequiredModels: "Modèles requis manquants : {models}. Podcast Geeker pourrait ne pas fonctionner correctement sans eux.",
