export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 Podcast Geeker API 服务器",
    dbTitle: "数据库连接失败",
  ...
  podcasts: {
    ...
    generationMode: "生成模式",
    generationModeLegacy: "传统 Agent",
    generationModeMultiAgent: "多 Agent",
    generationModeMultiAgentHint: "编排大纲、对话与配套流程以生成节目。",
    evaluationAgent: "评估 Agent",
    evaluationAgentHint: "开启后由独立流程检查大纲与逐字稿质量。",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Podcast Geeker 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，Podcast Geeker 可能无法正常运行。",
