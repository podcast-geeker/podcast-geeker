export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Podcast Geeker недоступен",
    ...
    docLink: "Документация Podcast Geeker",
  ...
  podcasts: {
    ...
    waveformLoading: "Загрузка формы волны…",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Podcast Geeker автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Podcast Geeker.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Podcast Geeker",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Podcast Geeker может работать некорректно без них.",
