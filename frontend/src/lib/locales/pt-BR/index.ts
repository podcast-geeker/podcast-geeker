export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Podcast Geeker não pôde ser alcançado",
    ...
    docLink: "Documentação do Podcast Geeker",
  ...
  podcasts: {
    ...
    waveformLoading: "Carregando forma de onda…",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Podcast Geeker exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Podcast Geeker está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Podcast Geeker",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Podcast Geeker pode não funcionar corretamente sem eles.",
