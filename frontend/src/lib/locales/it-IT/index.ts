export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Podcast Geeker non è raggiungibile",
    ...
    docLink: "Documentazione Podcast Geeker",
  ...
  podcasts: {
    ...
    waveformLoading: "Caricamento forma d’onda…",
    playAudio: "Riproduci",
    pauseAudio: "Pausa",
    segment: "Segmento",
    speaker: "Speaker",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Podcast Geeker di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Podcast Geeker.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Podcast Geeker",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Podcast Geeker potrebbe non funzionare correttamente senza questi.",
