export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Podcast Geeker API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  podcasts: {
    ...
    generationMode: "生成模式",
    generationModeLegacy: "傳統 Agent",
    generationModeMultiAgent: "多 Agent",
    generationModeMultiAgentHint: "編排大綱、對話與配套流程以產生節目。",
    evaluationAgent: "評估 Agent",
    evaluationAgentHint: "開啟後由獨立流程檢查大綱與逐字稿品質。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Podcast Geeker 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Podcast Geeker 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Podcast Geeker 可能無法正常運行。",
