export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Podcast Geeker API server could not be reached",
    ...
    docLink: "Podcast Geeker Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Podcast Geeker to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Podcast Geeker is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Podcast Geeker",
    missingRequiredModels: "Missing required models: {models}. Podcast Geeker may not function properly without these.",
