"""
Generic ContextBuilder for the Podcast Geeker project.
...
from podcast_geeker.domain.notebook import Note, Notebook, Source
from podcast_geeker.exceptions import DatabaseOperationError, NotFoundError
