...
- `podcast_geeker.ai.provision`: `provision_langchain_model()` (async factory with fallback logic)
- `podcast_geeker.domain.notebook`: Domain models (Source, Note, SourceInsight, vector_search)
- `loguru`: Logging
