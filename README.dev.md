...
This guide is for developers working on Podcast Geeker. For end-user documentation, see [README.md](README.md) and [docs/](docs/).
...
Podcast Geeker supports internationalization. To add a new language:
